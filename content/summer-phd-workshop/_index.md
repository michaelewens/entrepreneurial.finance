...
Complete the [application form](https://columbia.qualtrics.com/jfe/form/SV_d5Lt2Ifv0frqYoC) requiring biographical information, short cover letter, resume, and two short reference emails.
...
**Is this affiliated with Columbia University, Imperial College, or Nova SBE?**
No, the course has no connection to any university and is independently run by participating faculty.

**Will there be credit or a certificate?**
No, but students who complete the course will be listed on the course website.

**Where is the application form?**
The application is available [here](https://columbia.qualtrics.com/jfe/form/SV_d5Lt2Ifv0frqYoC).

**Will there be a remote or Zoom option?**
No.

**How are visas handled?**
A form letter is available to facilitate visa issues.

**What if I cannot make it this year?**
If successful, the workshop is planned annually in Europe with different institutions each summer (likely in June long-term).

For questions, contact Prof. Mike Ewens at michael.ewens@columbia.edu.
